...
export default function ModalMiddle({ isShow, setIsShow, setResetModal, children, className }) {
   return (
      ...
      >
         <div
            className={`relative rounded-2xl bg-white px-12 z-20 pb-14 text-black overflow-y-auto transition-all ease-in-out duration-500 transform h-fit top-1/2 -translate-y-1/2 ${
